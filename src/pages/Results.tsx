    ...
    try {
      ...
      if (state?.coaching_tips) {
        ...
        strengths.forEach(strength => {
          ...
          if (strengthsYPosition > 270) {
            pdf.addPage();
            strengthsYPosition = 30;
          }
        ...
        let tipsYPosition = growthYPosition + 25;
        splitTips.forEach((line: string) => {
          if (tipsYPosition > 270) {
            pdf.addPage();
            tipsYPosition = 30;
          }
          pdf.text(line, 20, tipsYPosition);
          tipsYPosition += 6;
        });
        
        // Update final Y position for footer
        yPosition = tipsYPosition;
      } else {
      ...
      pdf.text('Generated by Emotional Dynamics Indicator™', 20, Math.max(yPosition + 20, 280));
